...
```
    ...
    Info: Working in directory C:/Users/kryan/Desktop/School/BIMM 143/bimm143_github/class14
...
mitotic,” which aligns with the most significant pathway in my previous
KEGG results. A factor that could cause differences between these
methods is that they each use different databases, which may contain
slightly different information about what pathways the genes are
involved in.
